...
# 🎥 Demo (GIF Preview) #
<p align="center"> <img src="output_video-ezgif.com-video-to-gif-converter.gif" alt="Lane Detection Demo" width="700"/> </p>
...
## Canny Edge Detector ##
It computes gradient in all directions of our blurred image and traces the edges with large changes in intensity. For more explanation please go through this article:https://www.geeksforgeeks.org/python/real-time-edge-detection-using-opencv-python/
